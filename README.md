## **This is a project I developed during the Udemy course ".NET 8 Microservices: DDD, CQRS, Vertical/Clean Architecture."**
...
There is a couple of microservices which implemented **e-commerce** modules over **Catalog, Basket, Discount** and **Ordering** microservices with **NoSQL (DocumentDb, Redis)** and **Relational databases (PostgreSQL, Sql Server)** with communicating over **RabbitMQ Event Driven Communication**
...
5. Import the Postman collection to test all microservices. The collection can be found on the main page of the repository, along with the README.md file.